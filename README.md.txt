...
## How To Build
You will need a JDK installed -- see https://www.oracle.com/java/technologies/downloads/ .  This project uses Java 23.0.1. 
...
- As it is currently implemented, everything is stored in memory on a single node and if that node goes down, all the readings are lost.  If I had more time, I would have liked to implement some redundancy -- more than one node, keeping their data redundant between them, but this was outside the scope of what coudl be done in 2 hours.  
